...
AITO Controller Classification
-------------------------------
BENCHMARK controllers (used in experiment runner comparisons only):
- RandomForestController
- XGBoostController
- GradientBoostingController
- MLPController (PyTorch 3-layer MLP)

Note: LSTMForecastController and ImitationLearningController have been removed.
LSTMForecast performs prediction, not signal control (wrong abstraction).
ImitationLearning was trained on a trivial heuristic and adds no signal-timing insight.
"""
